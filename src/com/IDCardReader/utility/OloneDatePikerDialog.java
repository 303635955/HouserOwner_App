 ...
 * </p>
 */
public class OloneDatePikerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
	 ...
	 */
	public OloneDatePikerDialog(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
		this(context, 0, callBack, year, monthOfYear, dayOfMonth);
	}

	public OloneDatePikerDialog(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
			int dayOfMonth) {
	...
	public OloneDatePikerDialog(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
		...
		View view = inflater.inflate(R.layout.dateone_picker_dialog, null);
		setView(view);
		mDatePicker_start = (DatePicker) view.findViewById(R.id.one_datePickerStart);

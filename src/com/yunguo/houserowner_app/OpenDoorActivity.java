...
public class OpenDoorActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.addperson_activity);
		findView();
		initListView();
		setOnClick();
		animaition.start();
	...
	public void setOnClick(){
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(OpenDoorActivity.this,RemoteOpenDoorActivity.class);
		...
		backimg.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				/*Intent intent = new Intent(OpenDoorActivity.this,HomePageActivity.class);
				startActivity(intent);*/
				finish();
			}
		});
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			Toast.makeText(OpenDoorActivity.this, masg, Toast.LENGTH_SHORT).show();
		};
	};

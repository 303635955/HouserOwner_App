...
public class RemoteBreakDoorActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.remotebreakdoor_activity);
		findView();
		setAdapter();
		setOnClick();
		animaition.start();
	...
	public void setOnClick(){
		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if(RemoteBreakDoorActivity.this.getIntent().getStringExtra("type").equals("1")){
					Map<String,String> map = (Map<String, String>) openDoorAdapter.getItem(position);
					SerialNo = map.get("SerialNo");
					dialog.show();
					new Thread(thread2).start();
					finish();
				}else if (RemoteBreakDoorActivity.this.getIntent().getStringExtra("type").equals("2")) {
					Map<String,String> map = (Map<String, String>) openDoorAdapter.getItem(position);
					SerialNo = map.get("SerialNo");
					dialog.show();
					Intent intent =new Intent(RemoteBreakDoorActivity.this,CardPowerMessageActivity.class);
					intent.putExtra("no", SerialNo);
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			Toast.makeText(RemoteBreakDoorActivity.this, masg, Toast.LENGTH_SHORT).show();
		};
	};
	...
	private Thread thread = new Thread(){
		...
		public void run() {
			...
			String url = "http://192.168.1.151:8118/Client1/QueryLockers";
	...
	private Thread thread2 = new Thread(){
    	...
    	public void run() {
			...
			String url = "http://192.168.1.151:8118/HouseMobileApp/ProAppSetStateCode";
			Map<String, String> houseid = new HashMap<String, String>();
	...
	public List<Map<String, String>> getCardInfo(String res) {
		 List<Map<String, String>> tmpdata = new ArrayList<Map<String, String>>();
			try {
				JSONObject jsonObject2 = new JSONObject(res);
				JSONArray jsonArray = jsonObject2.getJSONArray("lockers");
				for (int i = 0; i < jsonArray.length(); i++) {
					Map<String, String> map = new HashMap<String, String>();
					JSONObject jsonObjectSon = (JSONObject) jsonArray.opt(i);
					String power= jsonObjectSon.get("CriPri")+"";
